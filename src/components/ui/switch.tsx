  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        ...
        "data-[state=checked]:bg-white after:content-[''] after:block data-[state=checked]:after:h-1.5 data-[state=checked]:after:w-1.5 data-[state=checked]:after:rounded-full data-[state=checked]:after:bg-transparent"
      )}
    />
  </SwitchPrimitives.Root>
))
